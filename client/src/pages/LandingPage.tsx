...
import { CheckSquare, Mic, Users, BarChart2, Shield, ArrowRight, Zap, Layout, Globe, Play, Coffee } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex justify-between items-center">
          ...
          <div className="flex gap-4 items-center">
            <a
              ...
              className="text-slate-400 hover:text-white transition hidden sm:block"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="mt-4 text-xs">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hover:underline opacity-60 hover:opacity-100 transition"
            >
              ☕ If Taskify helps you, consider supporting the developer.
            </a>
          </p>
        </div>
      </footer>
